...
client.login("OTYwMjE3MjQzNDY2MjE5NTkw.G7dhNB.oGfT67hPh5Cwftgea2DrqXdwSzExQXpS9GJVcU");
...
distube.on("searchNoresult", (message, query) => {
    message.channel.send("Non ho trovato la canzone che stai cercando :(")
})